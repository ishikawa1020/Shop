  ...
  const serviceData = useMemo(() => {
    ...
    if (country) {
      services = services.filter(
        (cou) =>
          ...
          cou?.symbol?.toLowerCase().includes(country.toLowerCase())
      );
    }
    ...
    if (language) {
      services = services.filter(
        (lan) =>
          ...
          lan.symbol.toLowerCase().includes(language.toLowerCase()) ||
    ...
    if (currency) {
      services = services.filter((cur) =>
        cur.symbol.toLowerCase().includes(currency.toLowerCase())
      );
    }
