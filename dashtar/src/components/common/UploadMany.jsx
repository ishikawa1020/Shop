    ...
    <div className=" lg:flex md:flex flex-grow-0">
      <div className="flex">
        <div ref={dRef} className="lg:flex-1 md:flex-1 mr-3 sm:flex-none">
          {(title === "Products" ||
            ...
            <button
              ...
              className="px-1.5 w-max border flex justify-center items-center border-gray-300 hover:border-emerald-400 hover:text-emerald-400  dark:text-gray-300 cursor-pointer h-10 w-20 rounded-md focus:outline-none"
            >
        ...
        <div className="lg:flex-1 md:flex-1 mr-3  sm:flex-none">
          <button
            style={{ padding: "0 5px", width: "max-content" }}
            ...
            <div className="flex">
              {loading ? (
                ...
                <Button
                  ...
                  className="h-10 ml-2 px-2 px-1.5"
                >
                  <span className="">
                    <FiPlus />
                  </span>
                  <span className="text-sx w-max">{t("ImportNow")}</span>
                </Button>
              )}
            </div>
          </div>
