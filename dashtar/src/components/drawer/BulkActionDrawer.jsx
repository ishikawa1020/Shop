...
const BulkActionDrawer = ({
  ...
  const handleSelect = (key) => {
    ...
    if (isCheck?.length === data[0]?.children?.length) {
      return notifyError("これは親カテゴリとして選択できません!");
      ...
      >
        ...
        <div className="flex flex-col w-full h-full justify-between">
          <div className="w-full relative p-6 border-b border-gray-100 bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300">
            <Title
              title={`選択した ${title} を更新`}
              description={`リストから選択した ${title} に変更を適用`}
            />
          </div>
              ...
              <div className="px-6 pt-8 flex-grow w-full h-full max-h-full pb-40 md:pb-32 lg:pb-32 xl:pb-32">
                {title === "Products" && (
                  <>
                    ...
                    <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                      <LabelArea label={t("Product Tags")} />
                      <div className="col-span-8 sm:col-span-4">
                        <ReactTagInput
                          placeholder="商品タグ（入力後、Enterキーを押して新しいタグを追加）"
                          tags={tag}
                ...
                {title === "Coupons" && (
                  <>
                    ...
                    <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                      <LabelArea label="終了時間" />
                      <div className="col-span-8 sm:col-span-4">
                        <Input
                          {...register(`endTime`, {
                            required: "クーポンの有効期限終了時間",
                          })}
                          label="クーポンの有効期限終了時間"
                          name="endTime"
                          type="datetime-local"
